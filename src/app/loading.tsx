    ...
    <div className="animate-pulse" aria-busy="true" aria-label="Carregando">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mb-6">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-xl border border-white/10 bg-[#0f1720] p-4">
      ...
      <div className="grid lg:grid-cols-3 gap-4">
        <div className="lg:col-span-2 rounded-xl border border-white/10 bg-[#0f1720] p-4">
          <div className="h-4 w-40 rounded bg-white/10" />
          <div className="mt-4 h-56 rounded-lg bg-white/10" />
        </div>
        <div className="rounded-xl border border-white/10 bg-[#0f1720] p-4">
