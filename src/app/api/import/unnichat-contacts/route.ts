...
// Rota ONE-OFF: carrega a base de contatos do Unnichat no banco.
// Protegida pela mesma chave do webhook. unnichat_contacts alimenta o cron
// que resolve o ID e puxa as conversas.
